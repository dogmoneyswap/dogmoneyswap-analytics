...
export const bar = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://thegraph.mistswap.fi/subgraphs/name/dogmoneyswap/bar",
    shouldBatch: true,
  }),
]);
...
export const masterchef = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://thegraph.mistswap.fi/subgraphs/name/dogmoneyswap/master-chef",
    shouldBatch: true,
  }),
]);
...
export const exchange = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://thegraph.mistswap.fi/subgraphs/name/dogmoneyswap/exchange",
    shouldBatch: true,
  }),
]);
...
export const blocklytics = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://thegraph.mistswap.fi/subgraphs/name/dogmoneyswap/blocks",
    shouldBatch: true,
  }),
]);
...
export const lockup = from([
  new RetryLink(),
  new HttpLink({
    uri: "https://thegraph.mistswap.fi/subgraphs/name/dogmoneyswap/lockup",
    shouldBatch: true,
  }),
]);
